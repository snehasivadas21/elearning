        ...
        <div className="w-80 bg-white border-r overflow-y-auto p-4">
          ...
          {quiz && (
            <div className="border-t pt-4 mt-2">
              <h2 className="font-semibold text-sm mb-3 text-purple-700">
                📘 Final Assessment
              </h2>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 space-y-2">
                ...
                <div className="text-xs text-gray-500 space-y-1">
                  <p>✅ Pass: {quiz.pass_percentage}%</p>
                  <p>🔁 Max Attempts: {quiz.max_attempts}</p>
                  {quiz.time_limit && <p>⏱ Time: {quiz.time_limit} mins</p>}
                </div>

                {allLessonsCompleted ? (
                  <button
                    onClick={() => navigate(`/student/courses/${id}/quiz/${quiz.id}`)}
                    className="w-full mt-2 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm rounded-lg transition-colors font-medium"
                  >
                    Take Quiz →
                  </button>
                ) : (
                  <div className="mt-2 text-xs text-gray-500 bg-gray-100 rounded-lg p-2 text-center">
